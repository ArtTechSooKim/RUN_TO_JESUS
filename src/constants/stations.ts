...
export const floors: { id: Floor; label: string; image: number; aspectRatio: number }[] = [
  {
    id: 'young-10f',
    label: '10층 영관',
    image: require('@/assets/images/floorplans/young-10f.png'),
    aspectRatio: 1160 / 920,
  },
  {
    id: 'young-11f',
    label: '11층 영관',
    image: require('@/assets/images/floorplans/young-11f.png'),
    aspectRatio: 1160 / 860,
  },
  {
    id: 'fashion-10f',
    label: '10층 패션관',
    image: require('@/assets/images/floorplans/fashion-10f.png'),
    aspectRatio: 1160 / 860,
  },
];
